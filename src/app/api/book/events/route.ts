...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    const env = getEnv();
    // Consent-Cookie: Env-Konfiguration zuerst; /buch-reddit behält sein eigenes
    // Banner-Cookie, alle anderen Seiten nutzen das First-Party-Cookie des
    // Consent-Banners (lze_marketing_consent).
    const fallback =
